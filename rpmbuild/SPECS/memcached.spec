%define prefix			/usr/local/memcached
...
install -Dp -m0755 scripts/memcached-tool %{buildroot}%{prefix}/bin/memcached-tool

# Init script
install -Dp -m0755 scripts/memcached.sysv %{buildroot}%{_initrddir}/memcached
sed -i s,'daemon memcached','daemon %{prefix}/bin/memcached',g %{buildroot}%{_initrddir}/memcached 
# Default configs
...
%{prefix}/share/man/man1/memcached.1*
%{_initrddir}/memcached
%{prefix}/include/memcached
