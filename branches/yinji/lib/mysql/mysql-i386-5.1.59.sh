...
#SRC_URI="http://mirrors.dev.shopex.cn/lnmpp/sources/mysql-5.1.59.tar.gz"
SRC_URI="http://lnmpp.googlecode.com/files/mysql-5.1.59.tar.gz"
...
mkdir -pv /data/mysql
/usr/local/mysql/bin/mysql_install_db --basedir=/usr/local/mysql --user=mysql --datadir=/data/mysql 
