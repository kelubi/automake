...
#
echo "[Zend Optimizer]" >> /usr/local/php/etc/php.ini
echo "zend_optimizer.optimization_level=1" >> /usr/local/php/etc/php.ini
echo "zend_extension=\"/usr/local/zend/ZendOptimizer.so\"" >> /usr/local/php/etc/php.ini
#
