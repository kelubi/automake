# $Id: distcc.spec 7982 2009-11-03 03:41:01Z dag $
# Authority: dag
...
start() {
	...
	PATH="$DISTCCPATH" daemon --user "$USER" $prog --allow 0.0.0.0/0 --daemon --log-file="%{_localstatedir}/log/distccd.log" $OPTIONS
	RETVAL=$?
	echo
...
%changelog
* Mon Mar 07 2005 Dag Wieers <dag@wieers.com> - 2.18.3-2 - 7982/dag
