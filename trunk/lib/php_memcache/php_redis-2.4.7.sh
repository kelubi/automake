...
SRC_URI="http://lnmpp.googlecode.com/files/nicolasff-phpredis-2.1.3-167-ga5e53f1.zip"
PKG_NAME=`basename $SRC_URI`
N="nicolasff-phpredis-2.1.3-167-ga5e53f1"
V="2.1.3"
...
sed -i '/\[redis\]/d' $PHPINI
sed -i '/extension=redis.so/d' $PHPINI
echo "[redis]" >> $PHPINI
